...
.container {
	...
	border-radius: 10px;
  	box-shadow: 0 14px 28px rgba(15, 125, 189, 0.25),
			0 10px 10px rgba(9, 103, 146, 0.849);
	position: relative;
	overflow: hidden;
	width: 768px;
	max-width: 100%;
...
.overlay {
	background: #6771f7;
	background: -webkit-linear-gradient(to right, #94d3e2, #076575d3);
	background: linear-gradient(to right,  #94d3e2, #049e8f);
