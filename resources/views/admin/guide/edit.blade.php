                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل بيانات مرشد
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card">
                                <div class="card-header"  style =" background-color:#049e8f ; height: 80px" >
                                    <img src="/admin/images/ico/gu3.jpg" style="width: 63px">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.guide.update', $guides ->id)}}" method="POST"
                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$guides -> name}}" id="name"
                                                               class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$guides -> special}}" id="name"
                                                               class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" value="{{$guides-> phone}}" id="name"
                                                               class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$guides -> password}}" id="name"
                                                               class="form-control"
