                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">   عرض منشورات المرشدين
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" style =" background-color:#049e8f  ; height: 80px ">
                                <img src="/admin/images/ico/gu5.jpg" style="width: 50px " >
                            ...
                            <div class="card-content collapse show">
                                ...
                                @foreach($guidePost as $val)
                                                ...
                                                {{-- <td><img width="50" height="60" src="{{url('/storage'.$val->image)}}"></td>
                                                <td><audio src="{{url('/storage'.$val->record)}}"></td> --}}
                                                <td>
                                                    <div class="btn-group" role="group"
                                                             aria-label="Basic example" >
                                                    <a href="{{route('Post.guide.delete',$val->id)}}"
