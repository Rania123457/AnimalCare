...
$messages = [
    ...
    //  $status['name'] = $guide->name;
        return redirect()->back()->with(['status'=>'تمت اضافة المرشد ']);
...
//delete data
      ...
      public function delete($guide_id){
        ...
        return redirect()
        ->back()
        ->with(['status' => 'العنصر غير موجود']);


       $offer -> delete();
        return redirect()
        ->back()
        ->with(['status' => 'تم الحذف بنجاح']);
      }
...
////////////////////////////// showposts //////////////////////////////
public function showposts_guide(){
...
public function deletePost_guide($id){
